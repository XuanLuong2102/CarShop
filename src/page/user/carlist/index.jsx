                ...
                <div className='container'>
                    <Row className='search_bar'>
                        ...
                        <Col className='filter-group' span={4}>
                            ...
                            <select name="" id="" placeholder='nghia'>
                                <option value="">Honda</option>
                                <option value="">Audi</option>
                                <option value="">Mescedes</option>
                    ...
                    <div className='boxcar-container'>
                        ...
                        <div className='pagination-sec'>
                            <nav className='page-navigation'>
                                <ul className='page-navigation__pagination'>
                                    <li className='page-navigation__pagination__item'>
                                        <a href="/" className='page-navigation__pagination__item__previos'><GrFormPrevious /></a>
                                    </li>
                                    <li className='page-navigation__pagination__item active'>
                                        <a href="/" className='page-navigation__pagination__item__link active'>1</a>
                                    </li>
                                    <li className='page-navigation__pagination__item'>
                                        <a href="/" className='page-navigation__pagination__item__link'>2</a>
                                    </li>
                                    <li className='page-navigation__pagination__item'>
                                        <a href="/" className='page-navigation__pagination__item__link'>3</a>
                                    </li>
                                    <li className='page-navigation__pagination__item'>
                                        <a href="/" className='page-navigation__pagination__item__link'>4</a>
                                    </li>
                                    <li className='page-navigation__pagination__item'>
                                        <a href="/" className='page-navigation__pagination__item__link'>5</a>
                                    </li>
                                    <li className='page-navigation__pagination__item'>
                                        <a href="/" className='page-navigation__pagination__item__link'>6</a>
                                    </li>
                                    <li className='page-navigation__pagination__item'>
                                        <a href="/" className='page-navigation__pagination__item__link'>7</a>
                                    </li>
                                    <li className='page-navigation__pagination__item'>
                                        <a href="/" className='page-navigation__pagination__item__link'>8</a>
                                    </li>
                                    <li className='page-navigation__pagination__item'>
                                        <a href="/" className='page-navigation__pagination__item__link'>9</a>
                                    </li>
                                    <li className='page-navigation__pagination__item'>
                                        <a href="/" className='page-navigation__pagination__item__link'>10</a>
                                    </li>
                                    <li className='page-navigation__pagination__item'>
                                        <a href="/" className='page-navigation__pagination__item__link'>11</a>
                                    </li>
                                    <li className='page-navigation__pagination__item'>
                                        <a href="/" aria-label='Next' className='page-navigation__pagination__item__next'><GrFormNext /></a>
                                    </li>
                                </ul>
                            </nav>
                        </div>
